## 프로젝트 개요
 ...
 영농형 태양광 관제 End-to-End MLOps 플랫폼입니다. 실시간 센서 데이터 처리, 시계열 예측, 자동화된 패널 최적화를 통합하여 작물 생장을 극대화하면서 태양 에너지 자원을 효율적으로 관리합니다.
...
설비 하부 환경 기온 예측을 위한 Transformer 기반 시계열 예측 모델
